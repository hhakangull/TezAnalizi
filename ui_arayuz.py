...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(100, 510))
        MainWindow.setMaximumSize(QtCore.QSize(5000, 3000))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("design_pages\\../icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("design_pages\\../2613204-200.png"))
